...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { estado_id: @aluno.estado_id, nome: @aluno.nome, sobrenome: @aluno.sobrenome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { estado_id: @aluno.estado_id, nome: @aluno.nome, sobrenome: @aluno.sobrenome } }
