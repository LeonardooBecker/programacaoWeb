...
canvas.addEventListener('contextmenu', function (event) {
    ...
    for (i = 0; i < allRetas.length; i++) {
        ...
        if (distancia < (tolerancia + 4)) {
            ...
            if (((allRetas[i].x1) <= (allRetas[i].x2)) && (x >= (allRetas[i].x1-tolerancia)) && (x <= (allRetas[i].x2+tolerancia))) {
                if (((allRetas[i].y1) <= (allRetas[i].y2)) && (y >= (allRetas[i].y1-tolerancia)) && ((y <= allRetas[i].y2+tolerancia))) {
                    isReta = true;
                }
                else if (((allRetas[i].y1) >= (allRetas[i].y2)) && (y <= (allRetas[i].y1+tolerancia)) && (y >= (allRetas[i].y2+tolerancia))) {
                    isReta = true;
                }
            }
            else if (((allRetas[i].x2) <= (allRetas[i].x1)) && (x >= (allRetas[i].x2-tolerancia)) && (x <= (allRetas[i].x1+tolerancia))) {
                if (((allRetas[i].y1) <= (allRetas[i].y2)) && (y >= (allRetas[i].y1-tolerancia)) && (y <= (allRetas[i].y2+tolerancia))) {
                    isReta = true;
                }
                else if (((allRetas[i].y1) >= (allRetas[i].y2)) && (y <= (allRetas[i].y1+tolerancia)) && (y >= (allRetas[i].y2-tolerancia))) {
